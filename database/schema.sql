...
--
-- Portable version of database/schema.pg_dump.sql: the psql meta-commands,
-- the dumping server's session settings and the "OWNER TO postgres" lines are
-- stripped, so this applies cleanly to hosted Postgres (Neon, Supabase,
-- Vercel Postgres) as well as a local server.
--
--   psql "$DATABASE_URL" -f database/schema.sql
--
-- It creates the tables only. Create a login with tools/create_admin.py.
--
